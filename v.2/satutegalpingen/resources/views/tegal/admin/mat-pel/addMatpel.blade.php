...
<!-- <figure class="wp-block-table is-style-stripes">
    <form class="m-3" action="/t3g4l/adminministrator/mat-pel/submit" method="post" enctype="multipart/form-data">
      @csrf
...
<div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col">
                    <form action="/t3g4l/adminministrator/mat-pel/submit" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
