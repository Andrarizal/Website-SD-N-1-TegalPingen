...
@section('content')
@auth
    <!-- <form class="m-3" action="/t3g4l/adminministrator/tenaga/submit" method="post" enctype="multipart/form-data">
      @csrf
...
<div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col">
                    <form action="/t3g4l/adminministrator/tenaga/submit" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                           <label for="title">Nama Prestasi</label>
                           <input type="text" class="form-control" name="namaTenaga" id="title" placeholder="Masukan Nama">
