...
@section('content')
@auth
   <!--  <form class="m-3" action="/t3g4l/superministrator/tenaga/change/{{$tenaga->id}}" method="post" enctype="multipart/form-data">
            @method('put')
            @csrf
...
<div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col">
                    <form action="/t3g4l/superministrator/tenaga/change/{{$tenaga->id}}" method="post" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="form-group">
                           <label for="title">Nama </label>
