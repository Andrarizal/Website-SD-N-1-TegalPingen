        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="my-nav">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown {{ ($title === "Visi & Misi") ? 'active' : ''  }} ">
	 ...
	 <section id="visi_misi">
		...
		<br>
            ...
            <div class="row">
                ...
                <div class="col-md-6 pl-4 "> 
                    <h3>Misi</h3>
                    <p>1. Menggalang kerja sama dengan komite sekolah<br>
					   2. Melengkapi sarana dan prasarana<br>
					   3. Meningkatkan profesionalisme tenaga pendidik<br>
					   4. Meningkatkan gemar membaca bagi guru dan siswa<br>
					   5. Mengembangkan intelektual sisa agar memiliki daya pikir kreatif, jujur, dan berpengetahuan luas</p>
                </div>
            </div>
        </div>
