    ...
    @auth
        <form class="m-3" action="" method="post">
            ...
            <div class="form-group">
               <label for="namaSarana">Nama Berita</label>
               <input type="text" class="form-control" name="namaBerita" id="namaBerita" placeholder="Masukan Nama" value="{{$berita->title}}" required>
            </div>
