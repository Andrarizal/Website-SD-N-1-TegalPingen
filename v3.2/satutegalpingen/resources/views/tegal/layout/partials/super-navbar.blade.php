<!-- Logo Header -->
			<div class="logo-header" data-background-color="blue">
				...
				<a href="" class="logo">
					<span class="text-light fw-bold">Super Admin Panel</span>
				</a>
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="{{asset('')}}assets/admin/img/profile3.jpg" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4></h4>
