...
INSERT INTO `beritas` (`id`, `title`, `deskripsi`, `image`, `carosel`, `created_at`, `updated_at`, `penting`) VALUES
	(2, 'Vaksin Gajeh ddddddd', 'Mendapat Vaksin Pancen Oye', '1642692835.4694-0-1479599196.png', 'yes', '2022-01-20 05:14:02', '2022-01-21 11:26:05', 'yes');
...
-- Dumping data for table satutegalpingen.mata_pelajarans: ~3 rows (approximately)
...
-- Dumping data for table satutegalpingen.migrations: ~14 rows (approximately)
...
-- Dumping data for table satutegalpingen.prestasis: ~3 rows (approximately)
...
-- Dumping data for table satutegalpingen.sarana_prasaranas: ~2 rows (approximately)
...
INSERT INTO `users` (`id`, `name`, `email`, `username`, `password`, `is_admin`, `is_super`, `email_verified_at`, `remember_token`, `created_at`, `updated_at`) VALUES
	(3, 'Sanama Manggolia asasasasas', 'sanam@gmail.com', 'saname', '$2y$10$RxAQAAQZVzFbmWmJmM0ILuPBsRZ1w08TFHi.iJvF/ZN95VXU968t2', 'yes', 'no', NULL, NULL, '2022-01-16 11:05:14', '2022-01-21 11:29:02'),
