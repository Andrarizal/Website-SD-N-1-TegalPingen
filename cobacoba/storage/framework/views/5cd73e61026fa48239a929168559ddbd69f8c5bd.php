...
<?php $__env->startSection('content'); ?>
    <form method="post" action="<?php echo e(route('register.perform')); ?>">
        ...
        <input type="hidden" name="is_admin" value="<?php echo e($is); ?>" />
...
<?php echo $__env->make('layout.auth-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sdntegalpingen\resources\views/auth/register.blade.php ENDPATH**/ ?>