                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="/visi_misi" class="dropdown-item"id="test">Visi & Misi</a>
					...
					<li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="#" class="dropdown-item"id="test">Sarana Infrastruktur</a>
                            <a href="#" class="dropdown-item"id="test">Sarana Pembelajaran</a>
                        </div>
                    </li>
                    <li class="nav-item">
					...
					<li class="nav-item dropdown active">
					 ...
					 <li class="nav-item dropdown">
						...
						<div class="dropdown-menu">
							<a href="/Tatatertib" class="dropdown-item"id="test">Tata Tertib</a>
...
<div class="section-item-caption">
                    ...
                    <div class="section-item-slider">
                        <img class="foto-guru" src="assets/img/WhatsApp Image 2021-11-26 at 1.45.05 AM.jpeg" alt="">
                        <div class="section-item-caption">
                            <a href="">
                                <h5>Parkiran Sekolah</h5>
                            </a>
                            <a href="">
                ...
                <div class="col-md-3">
                    <div class="footer-col">
                        ...
                        <ul class="footer-nav">
                            ...
                            <li><a href="/SaranaPrasarana">Sumber Daya Manusia</a></li>
...
</html><?php /**PATH C:\laragon\www\sdntegalpingen\resources\views/Galeri.blade.php ENDPATH**/ ?>