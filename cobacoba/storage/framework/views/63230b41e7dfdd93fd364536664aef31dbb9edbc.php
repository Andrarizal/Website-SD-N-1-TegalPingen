...
<body>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="#sambutan" class="dropdown-item "id="test">Sejarah</a>
                            <a href="visi" class="dropdown-item"id="test">Visi & Misi</a>
							<a href="#pendidik" class="dropdown-item"id="test">Tenaga Pendidik</a>
					...
					<li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="SaranaPrasarana.html" class="dropdown-item"id="test">Sarana Infrastruktur</a>
                        </div>
                    </li>
                    <li class="nav-item">
					...
					<li class="nav-item dropdown">
					 ...
					 <li class="nav-item dropdown">
						...
						<div class="dropdown-menu">
							<a href="Tatatertib.html" class="dropdown-item"id="test">Tata Tertib</a>
							<a href="pengumuman.html" class="dropdown-item"id="test">Pengumuman Penting</a>
						</div>
                    </li>
                    <li class="nav-item">
	...
	<section id="hero-area">
        ...
        <div class="owl-carousel" id="slider-hero">
            ...
            <div class="slider-item">
                <div class="slider-item-img">
                    <img src="assets/img/WhatsApp Image 2022-01-12 at 6.47.11 PM (1).jpeg" alt="">
                </div>
                <div class="slider-item-content"> 
...
<section id="prestasi">
        <div class="container">
            ...
            <div class="btn-selengkapnya">
                <a href="prestasilain.html" class="btn btn-more">Lihat prestasi lainnya</a>
            </div>
        </div>
    </section>
	<!--prestasi-->
	...
	<section id="pendidik">
        <div class="container">
            ...
            <div class="btn-selengkapnya">
                <a href="guru.html" class="btn btn-more">Lihat semua Guru</a>
            </div>
        </div>
    </section>
    <!--pendidik-->
                ...
                <div class="col-md-3">
                    <div class="footer-col">
                        ...
                        <ul class="footer-nav">
                            ...
                            <li><a href="SaranaPrasarana.html">Sumber Daya Manusia</a></li>
...
<?php /**PATH C:\laragon\www\sdntegalpingen\resources\views/home.blade.php ENDPATH**/ ?>